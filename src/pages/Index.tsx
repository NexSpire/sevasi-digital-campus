...
const Index = () => {
  ...
  const highlights = [
    { icon: Clock, text: t("૫૫+ વર્ષનો ગૌરવશાળી ઈતિહાસ", "55+ years of glorious history") },
    { icon: Star, text: t("જિલ્લાની ટોચની ગુજરાતી માધ્યમ શાળા", "Top Gujarati medium school in the district") },
    { icon: CheckCircle, text: t("GSEB સાથે સંલગ્ન — માન્ય સંસ્થા", "Affiliated with GSEB — recognized institution") },
    { icon: Users, text: t("૨૫,૦૦૦+ ભૂતપૂર્વ વિદ્યાર્થીઓનું નેટવર્ક", "25,000+ alumni network") },
  ];
